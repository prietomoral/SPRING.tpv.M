...
public class Populate {
    ...
    public void createAlertsFamily() {
        AlertFamily familyAlert = new AlertFamily();
        Alert alert = alertDao.findAll().get(0);
        List<Alert> alerts = new ArrayList<Alert>();
        alerts.add(alert);
        familyAlert.setName("Colección primavera");
        familyAlert.setAlerts(alerts);
        alertFamilyDao.save(familyAlert);
    }
