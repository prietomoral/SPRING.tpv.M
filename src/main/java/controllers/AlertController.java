...
public class AlertController {
	...
	public List<AlertWrapperWarningCritical> findAlertWarningCritical() {
		...
		for (AlertWrapperWarningCritical alert : alertDao.findAlertsWarningCritical()) {
			...
			alertWrapperWarningCritical.setDescripcion(alert.getDescripcion());
			alertWrapperWarningCritical.setStock(alert.getStock());
