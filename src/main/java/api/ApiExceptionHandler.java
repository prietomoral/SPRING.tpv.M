...
public class ApiExceptionHandler {
	...
	@ExceptionHandler({ NotFoundUserIdException.class, NotFoundTicketIdException.class,
			TicketHasInvalidUserException.class, NotFoundAlertIdException.class, NotFoundVouchersException.class , NotFoundVoucherException.class })
	@ResponseBody
	...
	@ExceptionHandler({ MalformedHeaderException.class, InvalidUserFieldException.class,
			...
			WarningNotCanLessCritical.class })
	@ResponseBody
