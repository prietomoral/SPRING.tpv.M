tpv.controller('customerRegistrationController', ['$http', '$timeout', function ($http, $timeout) {
   "use strict";
    let self = this;
    ...
    self.registration = function (token,mobile,username,password) {
      const delay = 2000;
     
      $http.defaults.headers.common['Authorization'] = 'Basic ' + Base64.encode(token + ':');
      let config = {
 	            method: 'POST',
 	            url: "http://localhost:8080/SPRING.tpv.1.0.0-SNAPSHOT/api/v0/customers",
